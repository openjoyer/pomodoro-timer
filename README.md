...
- Устанавливает значение статус-бара. Добавляет переключение режимов старта и паузы по команде pomodoro.toggle
- export функция из библиотеки vscode

**Параметры**
- context - контекст расширения для управления подписками и ресурсами
```ts
